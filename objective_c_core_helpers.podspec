Pod::Spec.new do |s|
    ...
    s.description      = <<-DESC
This pod file contains objective_c core helpers, That's you use in your every project. You import helper files sepratally in your project ,Now don't need to import helpers files in your project just add pod into the podfile and install the pod files.
        DESC
